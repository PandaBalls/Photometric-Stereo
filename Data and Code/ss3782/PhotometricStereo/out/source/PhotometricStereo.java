...
static final String MASK = ".mask.jpg";
static final String PATTERN = ".%d.JPG";
...
static final boolean DO_DEPTH =   false;
...
public void setup() {
  ...
  try {
    ...
    while (sectionIterator.hasNext()) {
      ...
      Ini.Section section = ini.get(CHROME);
      DenseMatrix lights=readPoints3D(section.get(OUTPUT));
